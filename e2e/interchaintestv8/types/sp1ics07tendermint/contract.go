...
// AbiPublicTypes is a free data retrieval call binding the contract method 0xc59315a5.
//
// Solidity: function abiPublicTypes((bytes32,(bytes,bytes)[]) output, (((uint64,bytes32,bytes32),(uint64,bytes32,bytes32),(string,(uint8,uint8),uint32,uint64),(uint32,uint32),(uint32,uint32)),(bytes,bytes)[]) output2) pure returns()
func (_Contract *ContractCaller) AbiPublicTypes(opts *bind.CallOpts, output IMembershipMsgsMembershipOutput, output2 IUpdateClientAndMembershipMsgsUcAndMembershipOutput) error {
	var out []interface{}
...
//
// Solidity: function abiPublicTypes((bytes32,(bytes,bytes)[]) output, (((uint64,bytes32,bytes32),(uint64,bytes32,bytes32),(string,(uint8,uint8),uint32,uint64),(uint32,uint32),(uint32,uint32)),(bytes,bytes)[]) output2) pure returns()
func (_Contract *ContractSession) AbiPublicTypes(output IMembershipMsgsMembershipOutput, output2 IUpdateClientAndMembershipMsgsUcAndMembershipOutput) error {
...
//
// Solidity: function abiPublicTypes((bytes32,(bytes,bytes)[]) output, (((uint64,bytes32,bytes32),(uint64,bytes32,bytes32),(string,(uint8,uint8),uint32,uint64),(uint32,uint32),(uint32,uint32)),(bytes,bytes)[]) output2) pure returns()
func (_Contract *ContractCallerSession) AbiPublicTypes(output IMembershipMsgsMembershipOutput, output2 IUpdateClientAndMembershipMsgsUcAndMembershipOutput) error {
	return _Contract.Contract.AbiPublicTypes(&_Contract.CallOpts, output, output2)
}
