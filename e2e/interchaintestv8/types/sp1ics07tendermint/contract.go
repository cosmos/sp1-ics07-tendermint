...
// IMembershipMsgsUnionMembershipProof is an auto generated low-level Go binding around an user-defined struct.
type IMembershipMsgsUnionMembershipProof struct {
	Ics23Proof            []byte
	TrustedConsensusState IICS07TendermintMsgsConsensusState
}
...
// AbiPublicTypes is a free data retrieval call binding the contract method 0x2892c8e5.
//
// Solidity: function abiPublicTypes((bytes32,(bytes[],bytes)[]) o1, (((string,(uint8,uint8),(uint32,uint32),uint32,uint32,bool),(uint64,bytes32,bytes32),(uint64,bytes32,bytes32),uint64,(uint32,uint32),(uint32,uint32)),(bytes[],bytes)[]) o2, ((bytes32,bytes,bytes)) o3, (uint8,bytes) o4, ((bytes32,bytes,bytes),(uint64,bytes32,bytes32)) o5, ((bytes32,bytes,bytes)) o6, ((string,(uint8,uint8),(uint32,uint32),uint32,uint32,bool),uint64,(uint32,uint32),(uint32,uint32),(uint64,bytes32,bytes32),(uint64,bytes32,bytes32)) o7, ((bytes32,bytes,bytes)) o8, (bytes,(uint64,bytes32,bytes32)) o9) pure returns()
func (_Contract *ContractCaller) AbiPublicTypes(opts *bind.CallOpts, o1 IMembershipMsgsMembershipOutput, o2 IUpdateClientAndMembershipMsgsUcAndMembershipOutput, o3 IUpdateClientMsgsMsgUpdateClient, o4 IMembershipMsgsMembershipProof, o5 IMembershipMsgsSP1MembershipProof, o6 IMembershipMsgsSP1MembershipAndUpdateClientProof, o7 IMisbehaviourMsgsMisbehaviourOutput, o8 IMisbehaviourMsgsMsgSubmitMisbehaviour, o9 IMembershipMsgsUnionMembershipProof) error {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "abiPublicTypes", o1, o2, o3, o4, o5, o6, o7, o8, o9)
...
func (_Contract *ContractSession) AbiPublicTypes(o1 IMembershipMsgsMembershipOutput, o2 IUpdateClientAndMembershipMsgsUcAndMembershipOutput, o3 IUpdateClientMsgsMsgUpdateClient, o4 IMembershipMsgsMembershipProof, o5 IMembershipMsgsSP1MembershipProof, o6 IMembershipMsgsSP1MembershipAndUpdateClientProof, o7 IMisbehaviourMsgsMisbehaviourOutput, o8 IMisbehaviourMsgsMsgSubmitMisbehaviour, o9 IMembershipMsgsUnionMembershipProof) error {
	return _Contract.Contract.AbiPublicTypes(&_Contract.CallOpts, o1, o2, o3, o4, o5, o6, o7, o8, o9)
}
...
// HandleUnionMembershipProof is a free data retrieval call binding the contract method 0x8dc5cc3d.
//
// Solidity: function handleUnionMembershipProof((uint32,uint32) proofHeight, bytes proofBytes, bytes[] kvPath, bytes kvValue) view returns(uint256)
func (_Contract *ContractCaller) HandleUnionMembershipProof(opts *bind.CallOpts, proofHeight IICS02ClientMsgsHeight, proofBytes []byte, kvPath [][]byte, kvValue []byte) (*big.Int, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "handleUnionMembershipProof", proofHeight, proofBytes, kvPath, kvValue)
...
//
// Solidity: function handleUnionMembershipProof((uint32,uint32) proofHeight, bytes proofBytes, bytes[] kvPath, bytes kvValue) view returns(uint256)
func (_Contract *ContractSession) HandleUnionMembershipProof(proofHeight IICS02ClientMsgsHeight, proofBytes []byte, kvPath [][]byte, kvValue []byte) (*big.Int, error) {
	return _Contract.Contract.HandleUnionMembershipProof(&_Contract.CallOpts, proofHeight, proofBytes, kvPath, kvValue)
}

// HandleUnionMembershipProof is a free data retrieval call binding the contract method 0x8dc5cc3d.
//
// Solidity: function handleUnionMembershipProof((uint32,uint32) proofHeight, bytes proofBytes, bytes[] kvPath, bytes kvValue) view returns(uint256)
func (_Contract *ContractCallerSession) HandleUnionMembershipProof(proofHeight IICS02ClientMsgsHeight, proofBytes []byte, kvPath [][]byte, kvValue []byte) (*big.Int, error) {
	return _Contract.Contract.HandleUnionMembershipProof(&_Contract.CallOpts, proofHeight, proofBytes, kvPath, kvValue)
}
